...
| 🎯 **Filtre de Kalman — fondements théoriques** | Comprendre *d'où viennent* les équations du filtre de Kalman, pas seulement les réciter : de l'estimation sous incertitude à la boîte à outils probabiliste, la loi gaussienne et ses clôtures, le filtrage bayésien récursif, puis la dérivation du filtre **par trois chemins** (conditionnement gaussien, moindres carrés/MAP, BLUE), l'innovation, l'optimalité, le régime permanent (Riccati), la cohérence (NIS/NEES) et la robustesse numérique. 10 chapitres en français, orientés théorie et illustrés par des figures **calculées exactement**, avec exercices à solutions repliables. Versant théorique de l'[implémentation Rust](cours-rust-robotique/chapitre-13.html) ; les chapitres appliqués (fusion de capteurs, EKF/UKF) viendront ensuite. | [🌐 Voir le cours en ligne](https://core-engineering.github.io/training/cours-filtre-kalman/index.html) | [`index.html`](cours-filtre-kalman/index.html) |
